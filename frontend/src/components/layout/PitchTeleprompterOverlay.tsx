...
import { Play, ChevronRight, ChevronLeft, X, ShieldAlert, Sparkles, Tv } from 'lucide-react';
...
export const PITCH_STEPS: TeleprompterStep[] = [
  ...
  },
  {
    ...
    actionPrompt: 'Click MULE_RING-003 or scenario card -> Click "Launch Scenario". Then click Next Step.',
    script: [
  ...
  },
  {
    ...
    actionPrompt: 'Point at Incident Header -> Click a node on Fraud Graph -> Click evidence item -> Scroll to AI reasoning.',
    script: [
        ...
        <div className="flex items-center justify-between pb-3 mb-3 border-b border-slate-800 text-xs">
          ...
          <div className="flex items-center gap-2">
            <span className="hidden md:inline-block text-[10px] text-slate-400 font-mono">
              (Use <kbd className="px-1 py-0.5 bg-slate-800 rounded border border-slate-700">←</kbd> <kbd className="px-1 py-0.5 bg-slate-800 rounded border border-slate-700">→</kbd> keys to navigate)
            </span>
            <button
              onClick={onClose}
